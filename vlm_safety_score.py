...
# CONFIGURATION
# ==========================================
GEMINI_API_KEY = "AIzaSyAtg_2fuoc1AA2UfUJuFPNrk0CYkIzeM78"
genai.configure(api_key=GEMINI_API_KEY)

# We use 1.5 Flash because it is incredibly fast and excels at visual reasoning
model = genai.GenerativeModel('gemini-1.5-flash')


PLY_PATH = "logs/TUM/freiburg1_desk_seed1/260417-17:57:12/gsplat.ply"
PARAMS_PATH = "logs/TUM/freiburg1_desk_seed1/260417-17:57:12/params.npz"
CLASSIFIER_PATH = "logs/TUM/freiburg1_desk_seed1/260417-17:57:12/classifier.pth"
TUM_RGB_DIR = "data/TUM-DEVA/rgbd_dataset_freiburg1_desk/rgb/"
OUTPUT_PLY_PATH = "logs/TUM/freiburg1_desk_seed1/safety_gsplat.ply"
...
def extract_canonical_view(target_class_id, points_3d, class_ids):
    ...
    # 2. Parse the TUM dataset file for image names
    # We change TUM_RGB_DIR locally here to point to the base folder
    base_tum_dir = "data/TUM-DEVA/rgbd_dataset_freiburg1_desk/"
    with open(base_tum_dir + "rgb.txt", "r") as f:
        # Skip comments and grab the file paths
        lines = [l.strip().split() for l in f.readlines() if not l.startswith("#")]
        image_filenames = [l[1] for l in lines] # e.g., 'rgb/1305031102.175304.png'
    ...
    # Map the best w2c frame index back to the original TUM image list
    actual_image_idx = keyframe_indices[best_frame_idx]
    hero_img_path = os.path.join(base_tum_dir, image_filenames[actual_image_idx])
...
def query_vlm_safety(base64_image):
    ...
    # Call Gemini and force the output to be pure JSON
